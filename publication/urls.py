...
from publication.views import (
    ...
    ReportAPublicationView, RemovePublicationReportView,
)

router = DefaultRouter()
router.register(r"publication", PublicationListRetrieveView, basename="publication-list-retrieve")
router.register(r"publication", PublicationListRetrieveView, basename="publication-create-update-delete")
